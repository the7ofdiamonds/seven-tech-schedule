...
/* harmony import */ var _model_store_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/store.js */ "./src/model/store.js");
...
function App() {
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_redux__WEBPACK_IMPORTED_MODULE_1__.Provider, {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_4__.BrowserRouter, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Suspense, {
    ...
    path: "/schedule/:event",
    element: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Event, null)
  }))))));
}
...
/* harmony default export */ __webpack_exports__["default"] = (scheduleSlice);
...
const addUser = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createAsyncThunk)('users/adduser', async user_data => {
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().post('/wp-json/orb/v1/users', user_data);
    return response.data;
  } catch (error) {
    throw new Error(error.message);
  }
});
const getUser = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.createAsyncThunk)('user/getUser', async (_, {
  getState
}) => {
  const {
    user_email
...
/* harmony import */ var _controllers_scheduleSlice__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../controllers/scheduleSlice */ "./src/controllers/scheduleSlice.js");
/* harmony import */ var _controllers_usersSlice_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../controllers/usersSlice.js */ "./src/controllers/usersSlice.js");



const store = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__.configureStore)({
  reducer: {
    schedule: _controllers_scheduleSlice__WEBPACK_IMPORTED_MODULE_0__.scheduleSlice.reducer,
    users: _controllers_usersSlice_js__WEBPACK_IMPORTED_MODULE_1__.usersSlice.reducer
  }
});
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "seven-tech-schedule:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkseven_tech_schedule"] = self["webpackChunkseven_tech_schedule"] || [];
